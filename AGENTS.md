...
When coding work is initiated through Hermes, the Hermes/ACFS boundary is
defined in `/srv/hermes/project-context/HERMES_ACFS_OPERATING_MODEL.md`.
Hermes may act as personal assistant, memory layer, and coding intake, but ACFS
remains the source of truth for software-factory execution in `/data/projects`.
