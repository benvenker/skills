...
Create and polish Beads task graphs as behavioral execution contracts for fungible coding agents. The skill emphasizes outcome-first task design, dependency correctness, parent closure contracts, validation, BV readability, and reviewable PR-sized slices.
...
```bash
npx skills add benvenker/skills --skill beads-authoring-excellence -g -y
```
